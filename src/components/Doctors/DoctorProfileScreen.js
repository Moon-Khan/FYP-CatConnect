...
import { fetchDoctorDataFromFirestore, deleteDoctorProfile } from '../../Services/firebase';
...
const ProfileScreen = ({ navigation }) => {
    ...
    const fetchUserData = async (userId) => {
        try {
            const userDoc = await fetchDoctorDataFromFirestore(userId);
            if (userDoc.exists) {
    ...
    //     navigation.navigate('DoctorUpdateScreen');
    // };
        ...
        Alert.alert(
            ...
            [
                ...
                },
                {
                    ...
                    onPress: async () => {
                        try {
                            await deleteDoctorProfile(user.uid);
