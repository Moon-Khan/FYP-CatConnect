...
//         setDoctors(doctorsSnapshot._data);
//         setFilteredDoctors(doctorsSnapshot._data);
    ...
    <DoctorCard
      ...
      onPress={() => {
        const doctorDetails = {
          ...
          specialization: item._data.specialization,
          qualification: item._data.qualification,
          availability: item._data.availability,
          experience: item._data.experience,
          city: item._data.city,
          doctorId: item._data.doctorid, // Include doctor ID for booking appointments
        };
